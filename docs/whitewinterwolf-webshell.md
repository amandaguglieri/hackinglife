---
title: WhiteWinterWolf php webshell 
...
Source: [https://github.com/WhiteWinterWolf/wwwolf-php-webshell/blob/master/webshell.php](https://github.com/WhiteWinterWolf/wwwolf-php-webshell/blob/master/webshell.php).

It is similar to the [Antak Webshell in aspx from the nishang project](nishang.md) but with php. It generates a page on the server from which we can indicate the ip and port where we want to receive the output of the commands we introduce,
