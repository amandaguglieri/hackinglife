...
[Sherlock](https://github.com/amandaguglieri/Sherlock) is a PowerShell script to quickly find missing software patches for local privilege escalation vulnerabilities.
